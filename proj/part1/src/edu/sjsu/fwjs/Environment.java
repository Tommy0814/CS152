...
public class Environment {
    ...
    public Value resolveVar(String varName) {
        ...
        else if (this.outerEnv != null && this.outerEnv.resolveVar(varName) != null){
    ...
    public void createVar(String key, Value v) {
        // YOUR CODE HERE
    	if (this.env.containsKey(key)){
    		throw new RuntimeException("Key " + key + " has already been instantiated in this scope.");
    	}
    	this.env.put(key, v);
    }
}
